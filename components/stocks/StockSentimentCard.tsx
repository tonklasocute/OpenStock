...
export default function StockSentimentCard({ insight }: StockSentimentCardProps) {
    ...
    return (
        <section className="rounded-none border border-gray-600 bg-gray-800 p-5">
            <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-3 rounded-none border border-gray-600 bg-gray-800 p-4 md:min-w-[320px]">
                        <div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    {insight.sources.map((source) => (
                        <article
                            key={source.source}
                            className="rounded-none border border-gray-600 bg-gray-800 p-4"
                        >
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-3">
                                <div className="rounded-none border border-gray-600 bg-gray-900 p-3">
                                    <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-gray-500">
                                        Buzz
                                    </p>
